...
Fitur ini di *disable* !`
    ...
    if (msg) return conn.sendButton(m.chat, danied, msg, `${imgr + 'Access Danied'}`, [['MENU', '.menu'],['OWNER', '.owner']],m)
...
if (msgg) return conn.sendButton(m.chat, `${global.htki} VERIFY ${global.htka}`, msgg, `${imgr + 'Verify'}`, [['LOGIN', '.verify'],['SIGN-UP', '.verify']],m)
}    
