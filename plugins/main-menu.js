 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `📛)ഒ Info Bot`, rowId: ".info", description: "✧ Info nya FS BOT ><"},
	...
	{title: `💻)ഒ Bot Stats`, rowId: ".botinfo", description: "✧ Menampilkan Status 赤 FS - BOT"},
	{title: `📊)ഒ Test Speed`, rowId: ".testspeed", description: "✧ Test Install Speed BOT"},
	{title: `⚡)ഒ Speed`, rowId: ".speed", description: "✧ Kecepatan Respon 赤 FS - BOT..."},
	]
    },{
...
const listMessage = {
  text: tek,
  footer: '© INGRAM BOT | ALL RESERVED',
...
*/
	...
	/** Baru */
	let img = fs.readFileSync('./img/atas.jpeg')
	let img2 = fs.readFileSync('./img/bawahh.jpeg')
